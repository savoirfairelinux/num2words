...
class Num2WordsPLTest(TestCase):
    def test_cardinal(self):
        ...
        self.assertEqual(
            ...
            "devět trilionů dva biliardy sto padesát sedm bilionů sto osmdesát"
            "devět miliard osmset osmdesát tři miliony devětset jedna tisíc šestset sedmdesát šest"
        )
        self.assertEqual(
            num2words(719094234693663034822824384220291, lang='cz'),
            "sedmset devatenáct quintillionů devadesát čtyři kvadriliardy dvěstě"
            "třicet čtyři kvadriliony šestset devadesát tři triliardy šestset šedesát tři"
            "triliony třicet čtyři biliardy osmset dvacet dva biliony osmset dvacet čtyři"
            "miliardy třista osmdesát čtyři miliony dvěstě dvacet tisíc dvěstě devadesát jedna"
        )
