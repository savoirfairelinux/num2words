...
class Num2WordsPLTest(TestCase):
    def test_cardinal(self):
        ...
        self.assertEqual(num2words(101, lang='pl'), "sto jedna")
        self.assertEqual(num2words(110, lang='pl'), "sto deset")
        self.assertEqual(num2words(115, lang='pl'), "sto patnáct")
        self.assertEqual(num2words(123, lang='pl'), "sto dvacet tři")
        self.assertEqual(num2words(1000, lang='pl'), "tisíc")
        self.assertEqual(num2words(1001, lang='pl'), "tisíc jedna")
