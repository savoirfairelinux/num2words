...
class Num2WordsHETest(TestCase):
    ...
    def test_1_to_10(self):
        ...
        self.assertEqual(num2words(10, lang="he", gender='m', construct=True), u'עשרת')
    ...
    def test_11_to_19(self):
        ...
        self.assertEqual(num2words(16, lang="he", gender='m', construct=True), u'שישה עשר')
    ...
    def test_20_to_99(self):
        ...
        self.assertEqual(num2words(23, lang="he", construct=True), u'עשרים ושלוש')
        self.assertEqual(num2words(23, lang="he", gender='m', construct=True), u'עשרים ושלושה')
    ...
    def test_100_to_999(self):
        ...
        self.assertEqual(num2words(196, lang="he", gender='m'), u'מאה תשעים ושישה')
        self.assertEqual(num2words(196, lang="he", gender='m', construct=True), u'מאה תשעים ושישה')
    ...
    def test_1000_to_9999(self):
        ...
        self.assertEqual(num2words(1002, lang="he", gender='m', construct=True), u'אלף ושניים')
        self.assertEqual(num2words(1003, lang="he"), u'אלף ושלוש')
        self.assertEqual(num2words(1003, lang="he", gender='m'), u'אלף ושלושה')
        self.assertEqual(num2words(1003, lang="he", gender='m', construct=True), u'אלף ושלושה')
        self.assertEqual(num2words(1010, lang="he"), u'אלף ועשר')
        self.assertEqual(num2words(1010, lang="he", gender='m'), u'אלף ועשרה')
        self.assertEqual(num2words(1010, lang="he", gender='m', construct=True), u'אלף ועשרה')
        ...
        self.assertEqual(num2words(2002, lang="he", construct=True), u'אלפיים ושתיים')
        ...
        self.assertEqual(num2words(3100, lang="he", construct=True), u'שלושת אלפים ומאה')
        self.assertEqual(
    ...
    def test_10000_to_99999(self):
        ...
        self.assertEqual(num2words(25000, lang="he", construct=True), u'עשרים וחמישה אלף')
    ...
    def test_1000000_to_999999999999999(self):
        ...
        self.assertEqual(num2words(1000002, lang="he", construct=True), u'מיליון ושתיים')
        ...
        self.assertEqual(num2words(3000002, lang="he", construct=True), u'שלושה מיליון ושתיים')
        ...
        self.assertEqual(num2words(1000000002, lang="he", construct=True), u'מיליארד ושתיים')
        ...
        self.assertEqual(num2words(3000000002, lang="he", construct=True), u'שלושה מיליארד ושתיים')
        ...
        self.assertEqual(num2words(10000000002, lang="he", construct=True), 'עשרה מיליארד ושתיים')
        ...
        self.assertEqual(num2words(1000000000002, lang="he", construct=True), u'טריליון ושתיים')
        ...
        self.assertEqual(num2words(3000000000002, lang="he", construct=True), u'שלושה טריליון ושתיים')
        ...
        self.assertEqual(num2words(10000000000002, lang="he", construct=True), 'עשרה טריליון ושתיים')
        ...
        self.assertEqual(num2words(999999999999999, lang="he", gender='m', construct=True), u'תשע מאות תשעים ותשעה טריליון תשע מאות תשעים ותשעה מיליארד תשע מאות תשעים ותשעה מיליון תשע מאות תשעים ותשעה אלף תשע מאות תשעים ותשעה')
    ...
    def test_to_ordinal(self):
        ...
        self.assertEqual(n.to_ordinal(10, gender='f', definite=True), u'העשירית')
        ...
        self.assertEqual(num2words(1, ordinal=True, lang='he', gender='f', definite=True), u'הראשונה')
    ...
    def test_to_ordinal_plural(self):
        ...
        self.assertEqual(n.to_ordinal(1501, plural=True), u'האלף חמש מאות ואחד')
        self.assertEqual(n.to_ordinal(1501, definite=True, plural=True), u'האלף חמש מאות ואחד')
        self.assertEqual(n.to_ordinal(1, plural=True), u'ראשונים')
        self.assertEqual(n.to_ordinal(1, definite=True, plural=True), u'הראשונים')
        self.assertEqual(n.to_ordinal(1, gender='f', plural=True), u'ראשונות')
        self.assertEqual(n.to_ordinal(1, gender='f', definite=True, plural=True), u'הראשונות')
        self.assertEqual(n.to_ordinal(10, plural=True), u'עשיריים')
        self.assertEqual(n.to_ordinal(10, definite=True, plural=True), u'העשיריים')
        self.assertEqual(n.to_ordinal(10, gender='f', plural=True), u'עשיריות')
        self.assertEqual(n.to_ordinal(10, gender='f', definite=True, plural=True), u'העשיריות')
        self.assertEqual(n.to_ordinal(17, plural=True), u'השבעה עשר')
        self.assertEqual(n.to_ordinal(17, definite=True, plural=True), u'השבעה עשר')
        self.assertEqual(n.to_ordinal(17, gender='f', plural=True), u'השבע עשרה')
        self.assertEqual(n.to_ordinal(17, gender='f', definite=True, plural=True), u'השבע עשרה')
        ...
        self.assertEqual(n.to_ordinal(0, gender='f', definite=True, plural=True), u'האפס')
        self.assertEqual(n.to_ordinal(999999, plural=True), u'התשע מאות תשעים ותשעה אלף תשע מאות תשעים ותשעה')
        self.assertEqual(n.to_ordinal(999999, gender='f', plural=True), u'התשע מאות תשעים ותשעה אלף תשע מאות תשעים ותשע')
        self.assertEqual(num2words(1, ordinal=True, lang='he', plural=True), u'ראשונים')
        self.assertEqual(num2words(1, ordinal=True, lang='he', gender='f', plural=True), u'ראשונות')
        self.assertEqual(num2words(1, ordinal=True, lang='he', definite=True, plural=True), u'הראשונים')
        self.assertEqual(num2words(1, ordinal=True, lang='he', gender='f', definite=True, plural=True), u'הראשונות')
