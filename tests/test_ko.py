...
class Num2WordsKOTest(TestCase):
    ...
    def test_ordinal(self):
        cases = [(1, "한 번째"), (101, "백 한 번째"), (2, "두 번째"), (5, "다섯 번째"),
                 (10, "열 번째"), (20, "스물 번째"), (100, "백 번째"), (1000, "천 번째"), 
                 (10000, "만 번째"), (100000, "십만 번째"), (1000000, "백만 번째"), 
                 (10000000, "천만 번째"), (100000000, "일억 번째"), (1000000000, "십억 번째"),
                 (10000000000, "백억 번째"), (100000000000, "천억 번째"),
                 (1000000000000, "일조 번째"), (10000000000000, "십조 번째"),
