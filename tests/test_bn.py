...
class Num2WordsBNTest(TestCase):
    ...
    def test_1000_to_9999(self):
        ...
        self.assertEqual(num2words(7378, lang="bn"), u'সাত হাজার তিনশত আটাত্তর')
        self.assertEqual(num2words(9999, lang="bn"), u'নয় হাজার নয়শত নিরানব্বই')

    def test_10000_to_99999(self):
        self.assertEqual(num2words(10000, lang="bn"), u'দশ হাজার')
        self.assertEqual(num2words(10501, lang="bn"), u'দশ হাজার পাঁচশত এক')
        self.assertEqual(num2words(10999, lang="bn"), u'দশ হাজার নয়শত নিরানব্বই')
        self.assertEqual(num2words(13000, lang="bn"), u'তেরো হাজার')
        self.assertEqual(num2words(15333, lang="bn"), u'পনের হাজার তিনশত তেত্রিশ')
        ...
        self.assertEqual(num2words(68700, lang="bn"), u'আটষট্টি হাজার সাতশত')
        self.assertEqual(num2words(73781, lang="bn"), u'তিয়াত্তর হাজার সাতশত একাশি')
        self.assertEqual(num2words(99999, lang="bn"), u'নিরানব্বই হাজার নয়শত নিরানব্বই')

    def test_100000_to_999999(self):
        self.assertEqual(num2words(100000, lang="bn"), u'এক লাখ')
        self.assertEqual(num2words('100000', lang="bn"), u'এক লাখ')
        self.assertEqual(num2words(199999, lang="bn"), u'এক লাখ নিরানব্বই হাজার নয়শত নিরানব্বই')
        self.assertEqual(num2words(110000, lang="bn"), u'এক লাখ দশ হাজার')
        self.assertEqual(num2words(150010, lang="bn"), u'এক লাখ পঞ্চাশ হাজার দশ')
        self.assertEqual(num2words('200200', lang="bn"), u'দুই লাখ দুইশত')
        self.assertEqual(num2words(737812, lang="bn"), u'সাত লাখ সাতত্রিশ হাজার আটশত বারো')
        self.assertEqual(num2words('999999', lang="bn"), u'নয় লাখ নিরানব্বই হাজার নয়শত নিরানব্বই')
    ...
    def test_1000000_to_9999999999999999(self):
        ...
        self.assertEqual(num2words(900000000000000, lang="bn"), u'নয় কোটি কোটি')
        self.assertEqual(num2words(999999999999999, lang="bn"),
                         u'নয় কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই')
        self.assertEqual(num2words(9999999999999999, lang="bn"),
                         u'নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই')
    ...
    def test_dosomik_0_to_999999999999999999(self):
        ...
        self.assertEqual(num2words(16.9999, lang="bn"), u'ষোল দশমিক নয় নয় নয় নয়')
        self.assertEqual(num2words(19.56587, lang="bn"), u'উনিশ দশমিক পাঁচ ছয় পাঁচ আট সাত')
        ...
        self.assertEqual(num2words(92.978, lang="bn"), u'বিরানব্বই দশমিক নয় সাত আট')

        self.assertEqual(num2words(1000001.10, lang="bn"), u'দশ লাখ এক দশমিক এক')
        self.assertEqual(num2words(20000000.22, lang="bn"), u'দুই কোটি দশমিক দুই দুই')
        self.assertEqual(num2words(300030000.33, lang="bn"), u'ত্রিশ কোটি ত্রিশ হাজার দশমিক তিন তিন')
        self.assertEqual(num2words('4004000444.44', lang="bn"), u'চারশত কোটি চল্লিশ লাখ চারশত চৌচল্লিশ দশমিক চার চার')
        self.assertEqual(num2words(50000000001.50, lang="bn"), u'পাঁচ হাজার কোটি এক দশমিক পাঁচ')
        self.assertEqual(num2words(600000000600.66, lang="bn"), u'ষাট হাজার কোটি ছয়শত দশমিক ছয় ছয়')
        self.assertEqual(num2words(7000000000000.77, lang="bn"), u'সাত লাখ কোটি দশমিক সাত সাত')
        self.assertEqual(num2words(80000000000888.88, lang="bn"), u'আশি লাখ কোটি আটশত আটাশি দশমিক আট আট')
        self.assertEqual(num2words(900000000000000.9, lang="bn"), u'নয় কোটি কোটি দশমিক নয়')
        self.assertEqual(num2words(999999999999999.9, lang="bn"),
                         u'নয় কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই দশমিক নয়')
        self.assertEqual(num2words(9999999999999999.99, lang="bn"), u'একশত কোটি কোটি')
        self.assertEqual(num2words(99999999999999999.99, lang="bn"), u'এক হাজার কোটি কোটি')
        self.assertEqual(num2words('999999999999999999.9', lang="bn"),
                         u'নয় হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই দশমিক নয়')
    ...
    def test_to_currency(self):
        ...
        self.assertEqual(n.to_currency(99.99), u'নিরানব্বই টাকা নিরানব্বই পয়সা')
        self.assertEqual(n.to_currency(10000.1), u'দশ হাজার টাকা দশ পয়সা')
        self.assertEqual(n.to_currency(555555.50), u'পাঁচ লাখ পঞ্চান্ন হাজার পাঁচশত পঞ্চান্ন টাকা পঞ্চাশ পয়সা')
        self.assertEqual(n.to_currency(6666676), u'ছিষট্টি লাখ ছিষট্টি হাজার ছয়শত ছিয়াত্তর টাকা')
        self.assertEqual(n.to_currency(777777777), u'সাতাত্তর কোটি সাতাত্তর লাখ সাতাত্তর হাজার সাতশত সাতাত্তর টাকা')
        self.assertEqual(n.to_currency(7777777778),
                         u'সাতশত সাতাত্তর কোটি সাতাত্তর লাখ সাতাত্তর হাজার সাতশত আটাত্তর টাকা')
        self.assertEqual(n.to_currency(97777777778),
                         u'নয় হাজার সাতশত সাতাত্তর কোটি সাতাত্তর লাখ সাতাত্তর হাজার সাতশত আটাত্তর টাকা')
        self.assertEqual(n.to_currency(977777777781),
                         u'সাতানব্বই হাজার সাতশত সাতাত্তর কোটি সাতাত্তর লাখ সাতাত্তর হাজার সাতশত একাশি টাকা')
        self.assertEqual(n.to_currency(9777777779781),
                         u'নয় লাখ সাতাত্তর হাজার সাতশত সাতাত্তর কোটি সাতাত্তর লাখ উনআশি হাজার সাতশত একাশি টাকা')
    ...
    def test_to_cardinal(self):
        ...
        self.assertEqual(n.to_cardinal(19.56587), u'উনিশ দশমিক পাঁচ ছয় পাঁচ আট সাত')
        ...
        self.assertEqual(n.to_cardinal(300030000.33), u'ত্রিশ কোটি ত্রিশ হাজার দশমিক তিন তিন')
        self.assertEqual(n.to_cardinal('4004000444.44'), u'চারশত কোটি চল্লিশ লাখ চারশত চৌচল্লিশ দশমিক চার চার')
        self.assertEqual(n.to_cardinal(50000000001.50), u'পাঁচ হাজার কোটি এক দশমিক পাঁচ')
        self.assertEqual(n.to_cardinal(600000000600.66), u'ষাট হাজার কোটি ছয়শত দশমিক ছয় ছয়')
        self.assertEqual(n.to_cardinal(7000000000000.77), u'সাত লাখ কোটি দশমিক সাত সাত')
        self.assertEqual(n.to_cardinal(80000000000888.88), u'আশি লাখ কোটি আটশত আটাশি দশমিক আট আট')
        self.assertEqual(n.to_cardinal(900000000000000.9), u'নয় কোটি কোটি দশমিক নয়')
        self.assertEqual(n.to_cardinal(999999999999999.9),
                         u'নয় কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই দশমিক নয়')
        self.assertEqual(n.to_cardinal(9999999999999999.99), u'একশত কোটি কোটি')
        self.assertEqual(n.to_cardinal(99999999999999999.99), u'এক হাজার কোটি কোটি')
        self.assertEqual(n.to_cardinal('999999999999999999.99'),
                         u'নয় হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই দশমিক নয় নয়')
    ...
    def test_to_ordinal(self):
        ...
        self.assertEqual(n.to_ordinal(19.56587), u'উনিশ দশমিক পাঁচ ছয় পাঁচ আট সাত')
        ...
        self.assertEqual(n.to_ordinal(300030000.33), u'ত্রিশ কোটি ত্রিশ হাজার দশমিক তিন তিন')
        self.assertEqual(n.to_ordinal('4004000444.44'), u'চারশত কোটি চল্লিশ লাখ চারশত চৌচল্লিশ দশমিক চার চার')
        self.assertEqual(n.to_ordinal(50000000001.50), u'পাঁচ হাজার কোটি এক দশমিক পাঁচ')
        self.assertEqual(n.to_ordinal(600000000600.66), u'ষাট হাজার কোটি ছয়শত দশমিক ছয় ছয়')
        self.assertEqual(n.to_ordinal(7000000000000.77), u'সাত লাখ কোটি দশমিক সাত সাত')
        self.assertEqual(n.to_ordinal(80000000000888.88), u'আশি লাখ কোটি আটশত আটাশি দশমিক আট আট')
        self.assertEqual(n.to_ordinal(900000000000000.9), u'নয় কোটি কোটি দশমিক নয়')
        self.assertEqual(n.to_ordinal(999999999999999.9),
                         u'নয় কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই কোটি নিরানব্বই লাখ নিরানব্বই হাজার নয়শত নিরানব্বই দশমিক নয়')
        self.assertEqual(n.to_ordinal(9999999999999999.99), u'একশত কোটি কোটি')
        self.assertEqual(n.to_ordinal(99999999999999999.99), u'এক হাজার কোটি কোটি')
