...
class Num2WordsMGMTest(TestCase):
    ...
    def test_cardinal_integer(self):
        ...
        self.assertEqual(
            num2words(99, lang="mgm"), "guul hoho paat resi hoho paat"
        )
        ...
        self.assertEqual(
            num2words(114, lang="mgm"), "atus iid saguul resi paat"
        )
        self.assertEqual(
            num2words(128, lang="mgm"), "atus iid guul ruu resi hoho teil"
        )
        self.assertEqual(
            num2words(151, lang="mgm"), "atus iid guul liim resi iid"
        )
        self.assertEqual(
            num2words(713, lang="mgm"), "atus hoho ruu saguul resi teil"
        )
        self.assertEqual(
            num2words(999, lang="mgm"),
            "atus hoho paat guul hoho paat resi hoho paat",
        )
        self.assertEqual(num2words(1000, lang="mgm"), "rihun iid")
        self.assertEqual(num2words(1001, lang="mgm"), "rihun iid resi iid")
        self.assertEqual(
            num2words(1011, lang="mgm"), "rihun iid saguul resi iid"
        )
        self.assertEqual(
            num2words(1111, lang="mgm"), "rihun iid atus iid saguul resi iid"
        )
        self.assertEqual(
            num2words(2357, lang="mgm"),
            "rihun ruu atus teil guul liim resi hoho ruu",
        )
        self.assertEqual(num2words(2200, lang="mgm"), "rihun ruu atus ruu")
        self.assertEqual(
            num2words(2230, lang="mgm"), "rihun ruu atus ruu guul teil"
        )
        self.assertEqual(
            num2words(73400, lang="mgm"),
            "rihun guul hoho ruu resi teil atus paat",
        )
        self.assertEqual(
            num2words(73421, lang="mgm"),
            "rihun guul hoho ruu resi teil atus paat guul ruu resi iid",
        )
        self.assertEqual(num2words(100000, lang="mgm"), "rihun atus iid")
        self.assertEqual(
            num2words(250050, lang="mgm"), "rihun atus ruu guul liim guul liim"
        )
        self.assertEqual(num2words(6000000, lang="mgm"), "miliaun hohon iid")
        self.assertEqual(num2words(100000000, lang="mgm"), "miliaun atus iid")
        self.assertEqual(
            num2words(19000000000, lang="mgm"),
            "miliaun rihun saguul resi hoho paat",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "miliaun paat rihun atus hohon"
            " iid guul teil resi liim atus iid resi ruu",
        )
        self.assertEqual(num2words(1000000000000, lang="mgm"), "biliaun iid")
        self.assertEqual(num2words(2000000000000, lang="mgm"), "biliaun ruu")
        self.assertEqual(
            num2words(1000000000000000, lang="mgm"), "biliaun rihun iid"
        )
        self.assertEqual(
            num2words(2000000000000000, lang="mgm"), "biliaun rihun ruu"
        )
        self.assertEqual(
            num2words(1000000000000000000, lang="mgm"), "triliaun iid"
        )
        self.assertEqual(
            num2words(2000000000000000000, lang="mgm"), "triliaun ruu"
        )
    ...
    def test_cardinal_float(self):
        ...
        self.assertEqual(
            num2words(Decimal("1.01"), lang="mgm"), "iid vírgula mamu iid"
        )
        self.assertEqual(
            num2words(Decimal("1.035"), lang="mgm"),
            "iid vírgula mamu teil liim",
        )
        self.assertEqual(
            num2words(Decimal("1.35"), lang="mgm"), "iid vírgula teil liim"
        )
        self.assertEqual(
    ...
    def test_ordinal(self):
        ...
        self.assertEqual(num2words(20, lang="mgm", ordinal=True), "daguul ruu")
        ...
        self.assertEqual(
            num2words(99, lang="mgm", ordinal=True),
            "daguul hoho paat resi hoho paat",
        )
        ...
        self.assertEqual(
            num2words(100000, lang="mgm", ordinal=True), "darihun atus iid"
        )
        self.assertEqual(
    ...
    def test_currency_integer(self):
        ...
        self.assertEqual(
            self.n2w.to_currency(16.00), "dolar saguul resi hohon iid"
        )
        self.assertEqual(
            self.n2w.to_currency(17.00), "dolar saguul resi hoho ruu"
        )
        self.assertEqual(
            self.n2w.to_currency(18.00), "dolar saguul resi hoho teil"
        )
        self.assertEqual(
            self.n2w.to_currency(19.00), "dolar saguul resi hoho paat"
        )
        self.assertEqual(self.n2w.to_currency(20.00), "dolar guul ruu")

        self.assertEqual(
            self.n2w.to_currency(21.00), "dolar guul ruu resi iid"
        )
        self.assertEqual(
            self.n2w.to_currency(22.00), "dolar guul ruu resi ruu"
        )
        self.assertEqual(
            self.n2w.to_currency(35.00), "dolar guul teil resi liim"
        )
        self.assertEqual(
            self.n2w.to_currency(99.00), "dolar guul hoho paat resi hoho paat"
        )

        self.assertEqual(self.n2w.to_currency(100.00), "dolar atus iid")
        self.assertEqual(
            self.n2w.to_currency(101.00), "dolar atus iid resi iid"
        )
        self.assertEqual(
            self.n2w.to_currency(128.00),
            "dolar atus iid guul ruu resi hoho teil",
        )
        self.assertEqual(
            self.n2w.to_currency(713.00),
            "dolar atus hoho ruu saguul resi teil",
        )

        self.assertEqual(self.n2w.to_currency(1000.00), "dolar rihun iid")
        self.assertEqual(
            self.n2w.to_currency(1001.00), "dolar rihun iid resi iid"
        )
        self.assertEqual(
            self.n2w.to_currency(1111.00),
            "dolar rihun iid atus iid saguul resi iid",
        )
        self.assertEqual(
            self.n2w.to_currency(2114.00),
            "dolar rihun ruu atus iid saguul resi paat",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.n2w.to_currency(100000.00), "dolar rihun atus iid"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.n2w.to_currency(6000000.00), "dolar miliaun hohon iid"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.n2w.to_currency(1.00, currency="USD"), "dolar iid"
        )
        self.assertEqual(
            self.n2w.to_currency(1.50, currency="USD"),
    ...
    def test_currency_integer_negative(self):
        ...
        self.assertEqual(
            self.n2w.to_currency(-1000.00), "menus dolar rihun iid"
        )
        self.assertEqual(
    ...
    def test_year(self):
        ...
        self.assertEqual(
            self.n2w.to_year(1789),
            "rihun iid atus hoho ruu guul hoho teil resi hoho paat",
        )
        self.assertEqual(
            self.n2w.to_year(1942),
            "rihun iid atus hoho paat guul paat resi ruu",
        )
        self.assertEqual(
            self.n2w.to_year(1984),
            "rihun iid atus hoho paat guul hoho teil resi paat",
        )
        self.assertEqual(self.n2w.to_year(2000), "rihun ruu")
        self.assertEqual(self.n2w.to_year(2001), "rihun ruu resi iid")
        self.assertEqual(
            self.n2w.to_year(2016), "rihun ruu saguul resi hohon iid"
        )
    ...
    def test_year_negative(self):
        ...
        self.assertEqual(self.n2w.to_year(-10000), "rihun saguul muna Kristu")
