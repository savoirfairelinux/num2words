...
class Num2WordsHYTest(TestCase):
    ...
    def test_large_cardinal_numbers(self):
        ...
        self.assertEqual(num2words(100042, lang='hy'), 'հարյուր հազար քառասուն երկու')
    ...
    def test_ordinal_numbers(self):
        ...
        self.assertEqual(num2words(222, lang='hy', to='ordinal'), 'երկու հարյուր քսան երկուերորդ')
    ...
    def test_basic_currency(self):
        ...
        self.assertEqual(num2words(1.0, lang='hy', to='currency', currency='AMD'), 'մեկ դրամ')
        self.assertEqual(num2words(2.0, lang='hy', to='currency', currency='AMD'), 'երկու դրամ')
        self.assertEqual(num2words(100.0, lang='hy', to='currency', currency='EUR'), 'հարյուր եվրո')
        
        # Various currencies
        self.assertEqual(num2words(100, lang='hy', to='currency', currency='AMD'), 'հարյուր դրամ')
        self.assertEqual(num2words(100, lang='hy', to='currency', currency='RUB'), 'հարյուր ռուբլի')
        self.assertEqual(num2words(100, lang='hy', to='currency', currency='JPY'), 'հարյուր իեն')
        self.assertEqual(num2words(100, lang='hy', to='currency', currency='GBP'), 'հարյուր ֆունտ ստեռլինգ')
        self.assertEqual(num2words(100, lang='hy', to='currency', currency='CHF'), 'հարյուր շվեյցարական ֆրանկ')

    def test_currency_with_fractional_values(self):
        """Test currency conversion with fractional values."""
        # Fractional values
        self.assertEqual(num2words(1.5, lang='hy', to='currency', currency='USD'), 'մեկ դոլար ամբողջ հինգ տասներորդ ցենտ')
        self.assertEqual(num2words(100.00, lang='hy', to='currency', currency='USD'), 'հարյուր դոլար')
        self.assertEqual(num2words(100.42, lang='hy', to='currency', currency='USD'), 'հարյուր դոլար, քառասուն երկու ցենտ')
        
        # Special cases with cents
        self.assertEqual(num2words(1.25, lang='hy', to='currency', currency='USD'), 'մեկ դոլար քսանհինգ ցենտ')
        self.assertEqual(num2words(1.75, lang='hy', to='currency', currency='USD'), 'մեկ դոլար յոթանասունհինգ ցենտ')
        
        # Negative values
        self.assertEqual(num2words(-1.42, lang='hy', to='currency', currency='USD'), 'մինուս մեկ դոլար, քառասուն երկու ցենտ')
        
        # Fractional values without whole part
        self.assertEqual(num2words(0.5, lang='hy', to='currency', currency='USD'), 'հիսուն ցենտ')
    ...
    def test_currency_special_cases(self):
        ...
        # Unknown currency
        self.assertEqual(num2words(10, lang='hy', to='currency', currency='XXX'), 'տասը')
        
        # No cents option
        self.assertEqual(num2words(10, lang='hy', to='currency', currency='EUR', cents=False), 'տասը եվրո')
        
        # Negative values without fractions
        self.assertEqual(num2words(-100, lang='hy', to='currency', currency='EUR', cents=False), 'մինուս հարյուր եվրո')
    ...
    def test_year_conversion(self):
        ...
        self.assertEqual(num2words(1001, lang='hy', to='year'), 'հազար մեկ թվական')
        self.assertEqual(num2words(1066, lang='hy', to='year'), 'հազար վաթսուն վեց թվական')
        self.assertEqual(num2words(1800, lang='hy', to='year'), 'հազար ութ հարյուր թվական')
        self.assertEqual(num2words(2000, lang='hy', to='year'), 'երկու հազար թվական')
        self.assertEqual(num2words(2010, lang='hy', to='year'), 'երկու հազար տասը թվական')
