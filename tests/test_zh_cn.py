...
class Num2WordsZHTest(TestCase):
    def test_low(self):
        ...
        self.assertEqual(n2zh_cn(2, capital=True), "贰")
        self.assertEqual(n2zh_cn(6), "六")
        self.assertEqual(n2zh_cn(6, capital=True), "陆")

    def test_high(self):
        self.assertEqual(n2zh_cn(10000), "一万")
        self.assertEqual(n2zh_cn('10000', capital=True), "壹万")
        self.assertEqual(n2zh_cn(12345), "一万二千三百四十五")
        self.assertEqual(n2zh_cn('12345', capital=True),"壹万贰仟叁佰肆拾伍")
        self.assertEqual(n2zh_cn(10**8), "一亿")
        self.assertEqual(n2zh_cn(10**8, capital=True), "壹亿")
        self.assertEqual(n2zh_cn(1234567890), "十二亿三千四百五十六万七千八百九十")
        self.assertEqual(n2zh_cn(1234567890, capital=True),"壹拾贰亿叁仟肆佰伍拾陆万柒仟捌佰玖拾")
    ...
    def test_mid(self):
        ...
        self.assertEqual(n2zh_cn(-1000, capital=True), "负壹仟")
    ...
    def test_cardinal_float(self):
        ...
        self.assertEqual(n2zh_cn(10**8 + 0.01, capital=True),"壹亿点零壹")
