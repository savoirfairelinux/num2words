...
class Num2Word_PT_PT(lang_EU.Num2Word_EU):
    ...
    def setup(self):
        ...
        self.errmsg_nornum = "Apenas números podem ser convertido"
    ...
    def to_cardinal(self, value):
        result = super(Num2Word_PT_PT, self).to_cardinal(value)

        for ext in (
                'milhão', 'milhões', 'bilião', 'biliões',
                'trilhão', 'trilhões', 'quatrilhão', 'quatrilões'):
