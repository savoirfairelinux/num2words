...
CARDINAL_WORDS = [
    ZERO, "ün", "duos", "trais", "quatter", "tschinch", "ses", "set", "och",
    "nouv", "desch", "ündesch", "dudesch", "tredesch", "quattordesch",
    "quindesch", "saidesch", "dischset", "dischdoch", "dischnouv"
]

ORDINAL_WORDS = [
    ZERO, "prüm", "seguond", "terz", "quart", "tschinchevel", "sesevel",
    "settevel", "ochevel", "nouvevel", "deschevel", "ündeschevel",
    "dudeschevel", "tredeschevel", "quattordeschevel", "quindeschevel",
    "saideschevel", "dischsettevel", "dischdochevel", "dischnouvevel",
    "vainchevel"
]

# "20" = "vainch" / surface form is restaured during phonetic adaptation phase
STR_TENS = {2: "vaincha", 3: "trenta", 4: "quaraunta", 5: "tschinquaunta",
            6: "sesaunta", 7: "settaunta", 8: "ochaunta", 9: "nonaunta"}
...
class Num2Word_RM_PUTER:
    ...
    def float_to_words(self, float_number, ordinal=False):
        ...
        return prefix + Num2Word_RM_PUTER.FLOAT_INFIX_WORD + postfix
    ...
    def tens_to_cardinal(self, number):
        ...
        if tens in STR_TENS:
            ...
            prefix = CARDINAL_WORDS[tens][:-1] + "aunta"
    ...
    def to_cardinal(self, number):
        if number < 0:
            string = (Num2Word_RM_PUTER.MINUS_PREFIX_WORD +
    ...
    def to_ordinal(self, number):
        if number < 0:
            ordinal = (Num2Word_RM_PUTER.MINUS_PREFIX_WORD +
