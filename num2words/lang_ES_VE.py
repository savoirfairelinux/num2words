...
class Num2Word_ES_VE(Num2Word_EU):
    ...
    def setup(self):
        ...
        self.errmsg_nonnum = "Solo números pueden ser convertidos a letras."
        self.errmsg_toobig = "Numero muy grande para ser convertido a letras."
        self.gender_stem = "o"
        self.exclude_title = ["y", "menos", "punto"]
        self.mid_numwords = [(1000, "mil"), (100, "cien"),
                                            (90, "noventa"), (80, "ochenta"),
                                            (70, "setenta"), (60, "sesenta"),
