...
CARDINAL_WORDS = [
    ...
    "nov", "diesch", "endesch", "dodesch", "tredesch", "quittordesch", "quindesch",
    "sedesch", "dischset", "dischdotg", "dischnov"
]

ORDINAL_WORDS = [
    ZERO, "amprem", "sagond", "terz", "quart", "tschintgavel", "seisavel",
    "settavel", "otgavel", "novavel", "dieschavel", "endeschavel", "dodeschavel",
    "tredeschavel", "quittordeschavel", "quindeschavel", "sedeschavel",
    "dischsettavel", "dischdotgavel", "dischnovavel", "vantgavel"
]
...
def phonetic_contraction(string):
    ...
    NOTE: two forms of 1 exist (cardinal 'en' and pronoun 'egn') - the form 'egn'
...
class Num2Word_RM_SURMIRAN:
    ...
    def to_cardinal(self, number):
        if number < 0:
            string = Num2Word_RM_SURMIRAN.MINUS_PREFIX_WORD + self.to_cardinal(-number)
    ...
    def to_ordinal(self, number):
        tens = number % 100
        if number < 0:
            return Num2Word_RM_SURMIRAN.MINUS_PREFIX_WORD + self.to_ordinal(-number)
        elif number % 1 != 0:
