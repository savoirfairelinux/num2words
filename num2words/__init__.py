...
from . import (lang_AR, lang_CZ, lang_DE, lang_DK, lang_EN,
               lang_EN_IN, lang_ES, lang_ES_CO, lang_ES_NI,
               lang_ES_VE, lang_FI, lang_FR, lang_FR_BE, lang_FR_BR,
               lang_FR_CH, lang_FR_DZ, lang_HE, lang_HU, lang_ID,
